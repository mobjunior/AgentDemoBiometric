...
#include <fcntl.h>
#include <stdio.h>
#include "com_jb0762_pinpad_N20Epp.h"
...
JNIEXPORT jint JNICALL Java_com_jb0762_pinpad_N20Epp_pinpad_1get_1string
...
JNIEXPORT jint JNICALL Java_com_jb0762_pinpad_N20Epp_pinpad_1display_1string(
...
JNIEXPORT jint JNICALL Java_com_jb0762_pinpad_N20Epp_pinpad_1clear(JNIEnv *env,
		jobject thiz) {
	int ac = pinpad_clear();
	return ac;
}
 ...
 * Signature: ([C)I
 */
JNIEXPORT jint JNICALL Java_com_jb0762_pinpad_N20Epp_pinpad_1open(JNIEnv *env,
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_jb0762_pinpad_N20Epp_pinpad_1check_1conn(
 ...
 * Signature: (BB[BI)I
 */
JNIEXPORT jint JNICALL Java_com_jb0762_pinpad_N20Epp_pinpad_1inject_1masterkey(
 ...
 */
JNIEXPORT jint JNICALL Java_com_jb0762_pinpad_N20Epp_pinpad_1inject_1workkey(
 ...
 */
JNIEXPORT jint JNICALL Java_com_jb0762_pinpad_N20Epp_pinpad_1get_1pinblock(
 ...
 * Signature: (B[BS[B)I
 */
JNIEXPORT jint JNICALL Java_com_jb0762_pinpad_N20Epp_pinpad_1get_1mac(JNIEnv *env,
 ...
 * Signature: (B[BI[B)I
 */
JNIEXPORT jint JNICALL Java_com_jb0762_pinpad_N20Epp_pinpad_1encrypted_1track(
 ...
 * Signature: ([CI)I
 */
JNIEXPORT jint JNICALL Java_com_jb0762_pinpad_N20Epp_pinpad_1confirm_1amt(
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_jb0762_pinpad_N20Epp_pinpad_1close(JNIEnv *env,
		jobject thiz) {
	return pinpad_close();
}
