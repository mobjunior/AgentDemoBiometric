...
public class WithdrawPreviewActivity extends Activity {
...
//					Toast.makeText(WithdrawPreviewActivity.this, "No Paper.", Toast.LENGTH_SHORT).show();
//					return;
//				}
...
//                JBInterface.printImageInAssets(BalancePreview.this, "pic.bmp");
				JBInterface.print("     CASH WITHDRAWAL ");
				JBInterface.print("\n  " + strDateTime
						+ "\n\nName: " + strFirstName + " " + strLastName
						+ "\nPhone Number: " + account.getPhoneNumber()
						+ "\nAccount Number: " + account.getAccount()
