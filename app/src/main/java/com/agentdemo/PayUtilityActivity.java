 ...
 */
public class PayUtilityActivity extends Activity {

    public static String TAG = "PayUtilityActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.payutilty);
        initViews();
    }
    public void back(View v) {
        i = new Intent(this, PayUtilitiesOptionalActivity.class);
        startActivity(i);
    }
    private void initViews() {
        editNumber = (EditText) findViewById(R.id.edit_accountnumber);
        ...
        buttonOK = (Button) findViewById(R.id.btnpayutility);
        buttonOK.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if(TextUtils.isEmpty(number) || TextUtils.isEmpty(amount)) {
                    Toast.makeText(PayUtilityActivity.this, "All fields are mandatory!", Toast.LENGTH_SHORT).show();
                    return;
                }

                Intent intent = new Intent(PayUtilityActivity.this, MainActivity.class);
